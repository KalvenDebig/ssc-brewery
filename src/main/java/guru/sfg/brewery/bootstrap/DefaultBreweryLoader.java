...
public class DefaultBreweryLoader implements CommandLineRunner {
    ...
    private void loadCustomerData() {
        ...
        User stPeteUser = userRepository.save(User.builder()
                ...
                .customer(stPeteCustomer).build());

        User dunedinUser = userRepository.save(User.builder()
                .username("dunedin")
                .password(passwordEncoder.encode("password"))
                .customer(keyWestCustomer).build());
    ...
    private void loadSecurityData() {
        ...
        // Beer Order Admin
        Authority createBeerOrder = authorityRepository.save(Authority.builder().permission("order.create").build());
        Authority readBeerOrder = authorityRepository.save(Authority.builder().permission("order.create").build());
        Authority updateBeerOrder = authorityRepository.save(Authority.builder().permission("order.update").build());
        Authority deleteBeerOrder = authorityRepository.save(Authority.builder().permission("order.delete").build());
        ...
        log.debug("User load: " + userRepository.count());
    }
}
